    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article class="max-w-4xl mx-auto">
            ...
            <div class="mt-12 pt-8 border-t border-gray-100">
                <div class="flex justify-between items-center">
                     <div>
                        <span class="font-bold text-gray-900">Ulashish:</span>
        ...
        @if($relatedArticles->count() > 0)
            <div class="max-w-4xl mx-auto mt-16 pt-12 border-t border-gray-200">
                <h2 class="text-2xl font-bold text-gray-900 mb-8">O'xshash maqolalar</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    @foreach($relatedArticles as $related)
                        <div class="group">
                             <span class="text-xs text-gray-500 block mb-2">{{ $related->created_at->format('d.m.Y') }}</span>
                            <h3 class="font-bold text-lg text-gray-900 group-hover:text-[#F07F15] transition mb-2">
