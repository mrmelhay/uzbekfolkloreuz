...
@section('title', $subcategory->title . ' - ' . $category->title . ' - O\'zbek Folklori')
...
<div class="bg-gray-50 py-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ \App\Helpers\LinkHelper::route('category.show', ['slug' => $category->slug]) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-[#F07F15] md:ml-2">{{ $category->title }}</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">{{ $subcategory->title }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-12">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $subcategory->title }}</h1>
            <div class="h-1 w-16 bg-[#F07F15] mb-6"></div>
        </div>
        ...
        @else
             <div class="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <p class="text-gray-500 text-lg">Ushbu bo'limda hozircha maqolalar mavjud emas.</p>
            </div>
        @endif
    </div>
</div>
